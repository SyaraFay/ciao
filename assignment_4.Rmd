...
The p-value is 0.06871, this means that....
...
`rgdp60` is the value of the GDP per capita in 1960, converted to 1960 US dollars. I think the purpose to include the variable `rgdp60` is to......
...
According to this statistic, the main driver of economic growth is.... because...
